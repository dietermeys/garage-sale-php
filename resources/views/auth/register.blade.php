...
@section('content')
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('nr') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                            <input id="nr" type="number" class="form-control" name="nr"
                                                   value="{{ old('nr') }}">
                            ...
                            <div class="form-group{{ $errors->has('bus') ? ' has-error' : '' }}">
                                <label for="name" class="col-md-4 control-label">Bus</label>

                                <div class="col-md-6">
                                    <input id="bus" type="text" class="form-control" name="bus"
                                           value="{{ old('bus') }}">
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCDPwHa1WQaEsElyEQvOzNo6b0ab4QnKrA">
    </script>
    <script src="/js/geocoding.js">
    </script>
@endsection
